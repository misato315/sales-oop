                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" id="password" class="form-control" minlegth="8" aria-describedby="password-help" required>
                    ...
                    <p class="text-center mt-3 small">Registerd already?
